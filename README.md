...
How does an increasingly polarized legislature stay governable? Across six legislatures of roll-call
voting in the Brazilian Chamber of Deputies (2003 to 2026), the paper reconstructs coordination as
bipartite networks of agreement and shows that the chamber organizes by position relative to the
executive of the day, not along a fixed ideological axis. Its pragmatic center, the Centrão, is a
long-standing governista bloc whose position changed during the 2014 to 2016 crisis: once a
disciplined agent of the presidency, it became an autonomous pivot that sits in the largest
coordinating community under every government and, net of the president's party, supplies the
marginal majority on contested votes. Because the institutional shocks of the period are collinear,
the design does not estimate a single causal effect; it eliminates the main observable rivals and
reads the structure that survives.
...
The figures are named in reading order (`figure_01_...` to `figure_07_...`) plus the appendix
figures (`figure_B1_...`, `figure_F1_...`, `figure_G1_...`). See `figures/README.md` for what each
one shows and which analysis step produced it.
